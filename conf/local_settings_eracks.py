...
if 'test' in sys.argv:
    ...
    DATABASES = dict (
        default = dict (
            ...
            NAME = 'eracksnewdb',              # Or path to database file if using sqlite3.
            USER = 'eracksnewdb',                # Not used with sqlite3.
            PASSWORD = 'eracksnewdb',         # Not used with sqlite3.        # Not used with sqlite3.
