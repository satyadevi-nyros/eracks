...
class CategoryImage (ImageBase, Publishable):  # ImageBase must be first for ordering to work
    fk_name     = 'category'
...
class ProductImage (ImageBase, Publishable):  # ImageBase must be first for ordering to work
    fk_name     = 'product'
...
class Product (Imageable):
    ...
    category    = models.ForeignKey("Categories", db_column='categoryid', help_text='Primary Category for this product.')
