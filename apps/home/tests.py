...
class FixturesTest(TestCase):
    fixtures = ['home.yaml', 'products.yaml']
...
''' all three sitemaps are now dynamic - write tests appropriately
    def test_ror(self):
        """
...
class SitemapLinksTest(TestCase):
    fixtures = ['products_all.yaml', 'quickpages.yaml', 'home.yaml']
    ...
    def test_xml_sitemap_and_all_links(self):
        ...
        for link in all_links:
            ...
            print link.firstChild.data, 'trying', urlpath
